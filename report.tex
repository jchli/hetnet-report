...
Prior to me being involved in the project, a lot of work has been done on the research on heterogeneous networks and Linux prototype implementation. Porting to Android started in Spring 2015. Here we briefly describe the various network protocols used in the project, and the architecture of the Linux prototype.
...
\begin{enumerate}
\item services supported: MMS, SUPL, DUN, FOTA, IMS, CBS, WIFI\_P2P, IA, RCS, XCAP, EIMS
\item status: INTERNET, NOT\_RESTRICTED, TRUSTED, VALIDATED
\item charateristics: NOT\_METERED, NOT\_VPN, CAPTIVE\_PORTAL
\item transport type: CELLULAR, WIFI, ETHERNET, BLUETOOTH, VPN
\item bandwidth: LinkUpBandwidth, LinkDownBandwidth
\end{enumerate}
