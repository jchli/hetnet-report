...
We show here some code snippets that demonstrate the core functionality implemented in the demo, and explain their purpose. \\
\begin{figure}[H]
  \centering
...
Currently, the demo is able to run on Android emulator. Since we don't have access to a device with both WiFi and cellular networks, network switching has not been tested. 
