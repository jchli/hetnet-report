...
\end{itemize}
With these services available, MIHUs use information obtained from these services to make decisions about handover and link selection. In our case, the MIHU would be our policy engine, which takes input from MIH, runs them through its algorithms, and decides whether to make a network switch. \\
...
We give a brief overview of the middleware's Linux implementation. This is mainly to provide an understanding of the existing implementation and 
